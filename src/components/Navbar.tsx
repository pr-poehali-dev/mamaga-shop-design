  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50" style={{ background: "rgba(13,11,8,0.95)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(201,168,76,0.12)" }}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <button onClick={() => scrollTo("Контакты")} className="hidden lg:flex btn-gold px-5 py-2.5 text-xs tracking-widest cursor-pointer items-center gap-2" style={{ borderRadius: "2px" }}>
