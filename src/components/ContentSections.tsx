...
const PORTFOLIO_ITEMS = [
  ...
  { title: "Пентхаус на Крестовском", desc: "Кухня с мраморными столешницами и латунной фурнитурой", tag: "Камень + Металл" },
...
const SERVICES = [
  ...
  { title: "Изготовление под заказ", desc: "Производство от 14 дней. Собственная мастерская в Санкт-Петербурге", icon: "Hammer" },
